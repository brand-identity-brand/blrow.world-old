    ...
    return (
      <>
        ...
        <main className={css.main}>
          ...
          <div className={css.a}>{"art missing."}</div>
        </main>
      </>
    );
  }
      ...
      <main className={css.main}>
        ...
        <div className={css.b}>
          <div
            ...
            onBlur={() => {
              ...
              if (
                ...
                titleRef.current.innerHTML.replace(/^\s+|\s+$/g, "")
              ) {
                setTimerState({
          ...
          <div
            ...
            onFocus={() => {
              setStatementEditing(true);
            }}
            onBlur={() => {
              setStatementEditing(false);
              if (
                getArtStatement(stage, art) === statementRef.current.innerHTML
              ) {
                setTimerState({
